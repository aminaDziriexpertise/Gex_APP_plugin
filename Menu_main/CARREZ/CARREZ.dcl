Justification : dialog
              { label =  "Plugin Zwcad CARREZ V0.1";
                ...
                : row {
                  ...
                  :row{
                          ...
                          label = "&Calques";
                          width = 7;      
                          : toggle {key = "2-tremie"  ; label = "GEX_EDS_carrez_poly_surf.";}  
                          : toggle {key = "3-h-180"  ; label = "GEX_EDS_carrez_poly_surf_annexe.";}    
                          : toggle {key = "5-pk" ; label = "GEX_EDS_txt_carrez.";}   
                          : toggle {key = "6-combles" ; label = "GEX_EDS_carrez_teinte.";}        
                          : toggle {key = "7-lt"  ; label = "GEX_EDS_carrez_probleme.";}          
                          ...
                          : column {
                              ...
                              width = 17;
                                ...
                                : button { label = "CARREZ";key = "SDP";fixed_width=true;is_cancel=true;width=18;}
