Justification : dialog
              { label =  "Plugin Zwcad SUB V0.1";
                ...
                : row {
                  ...
                  :row{
                          : boxed_column {  
                          label = "&Insertion des Blocs";
                          width = 7;      
                          : toggle {key = "2-tremie"  ; label = "LEG_SUB";}  
                          : toggle {key = "3-h-180"  ; label = "TOT_SUB";}    
                          : toggle {key = "5-pk" ; label = "TOT_AN_SUB";}   
                          ...
                          : column {
                              ...
                              width = 17;
                                ...
                                : button { label = "SUB";key = "SDP";fixed_width=true;is_cancel=true;width=18;}
